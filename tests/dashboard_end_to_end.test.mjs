        ...
        switch (cmd) {
          ...
          case "get_settings":
            return {
              ...
              launchAtLogin: false,
              autoUpdate: false,
              dashboardShowSession: true,
              dashboardShowWeekly: true,
              dashboardShowSafePace: true,
  ...
  async function boot() {
    ...
    window.__TAURI__.core.invoke = async (cmd) => {
      ...
      if (cmd === "get_settings") return {
        ...
        dashboardShowSession: true, dashboardShowWeekly: true, dashboardShowSafePace: true,
        colorApplyTo: { icon: true, number: true, dashboard: true, tooltip: true },
        sessionPlan: 44000, weeklyPlan: 200000, colorMode: "threshold", paceBand: 10,
