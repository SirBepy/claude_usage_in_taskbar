...
import sys
import numpy as np
# Vendored from ufal/whisper_streaming (MIT). librosa/soundfile are only used by
# the load_audio* file helpers below, which this sidecar never calls (it streams
# raw PCM). Imports made optional so the heavy librosa dep tree isn't required.
try:
    import librosa
except ImportError:
    librosa = None
