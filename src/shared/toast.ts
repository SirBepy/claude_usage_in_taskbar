...
export function showToast(msg: string): void {
  ...
  if (!t) {
    ...
    t.id = "__toast";
    t.style.cssText =
      "position:fixed;bottom:16px;left:50%;transform:translateX(-50%);background:var(--surface-alt,#2a2a3a);color:var(--text,#fff);padding:8px 14px;border-radius:6px;font-size:0.8rem;z-index:2000;opacity:0;transition:opacity 160ms;";
